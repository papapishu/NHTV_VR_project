namespace VRTK.Examples
{
    ...
    public class VRTK_ControllerEvents_ListenerExample : MonoBehaviour
    {
		...
		public GameObject leftClawFrame1;
		public GameObject leftClawFrame2;
        ...
        private void DoTriggerPressed(object sender, ControllerInteractionEventArgs e)
        {
			...
			leftClawFrame1.SetActive (false);
			leftClawFrame2.SetActive (true);

			audio.PlayOneShot (clawSound);
        }

        private void DoTriggerReleased(object sender, ControllerInteractionEventArgs e)
        {
            DebugLogger(e.controllerIndex, "TRIGGER", "released", e);
			leftClawFrame1.SetActive (true);
			leftClawFrame2.SetActive (false);
